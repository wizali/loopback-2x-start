...
!function(e,r){"use strict";function t(t){var n="";if(t.hasOwnProperty("fkid")&&r.isString(t.fkid)&&(n+="/"+t.fkid),t.hasOwnProperty("hasmany")&&r.isString(t.hasmany)&&(n+="/"+t.hasmany),r.isDefined(t.where)){var i="and";r.isDefined(t.where.logic)&&("and"===t.where.logic&&(i="and"),"or"===t.where.logic&&(i="or"));var o=0;r.forEach(t.where,function(e,r){"logic"!==r&&(n+=-1===n.indexOf("?")?"?":"&",n+=1===Object.keys(t.where).length?t.count?"where["+r+"]="+e:"filter[where]["+r+"]="+e:t.count?"where["+i+"]["+o+"]["+r+"]="+e:"filter[where]["+i+"]["+o+"]["+r+"]="+e,o++)})}r.isDefined(t.or)&&r.isArray(t.or)&&r.forEach(t.or,function(e,t){r.forEach(e,function(e,r){n+=-1===n.indexOf("?")?"?":"&",n+="filter[where][or]["+t+"]["+r+"]="+e})}),r.isDefined(t.and)&&r.isArray(t.and)&&r.forEach(t.and,function(e,t){r.forEach(e,function(e,r){n+=-1===n.indexOf("?")?"?":"&",n+="filter[where][and]["+t+"]["+r+"]="+e})}),r.isDefined(t.neq)&&r.isArray(t.neq)&&r.forEach(t.neq,function(e,t){r.forEach(e,function(e,r){n+=-1===n.indexOf("?")?"?":"&",n+="filter[where][and]["+t+"]["+r+"][neq]="+e})}),r.isArray(t.include)&&r.forEach(t.include,function(e){n+=-1===n.indexOf("?")?"?":"&",n+="filter[include]="+e}),r.isDefined(t.between)&&Object.keys(t.between).length>1&&r.isArray(t.between.val)&&(n+=-1===n.indexOf("?")?"?":"&",n+="filter[where]["+t.between.field+"][between][0]="+t.between.val[0],n+="&filter[where]["+t.between.field+"][between][1]="+t.between.val[1]),r.isDefined(t.order)&&(n+=-1===n.indexOf("?")?"?":"&",r.isDefined(t.order.field)&&(n+="filter[order]="+t.order.field),n+=r.isDefined(t.order.val)?" "+t.order.val:" DESC"),r.isNumber(t.limit)&&(n+=-1===n.indexOf("?")?"?":"&",n+="filter[limit]="+t.limit),r.isNumber(t.skip)&&(n+=-1===n.indexOf("?")?"?":"&",n+="filter[skip]="+t.skip),r.isDefined(t.like)&&r.isDefined(t.like.field)&&r.isDefined(t.like.val)&&(n+=-1===n.indexOf("?")?"?":"&",n+="filter[where]["+t.like.field+"][like]="+t.like.val),r.isDefined(t.lt)&&r.isDefined(t.lt.field)&&r.isDefined(t.lt.val)&&(n+=-1===n.indexOf("?")?"?":"&",n+="filter[where]["+t.lt.field+"][lt]="+t.lt.val),r.isDefined(t.gt)&&r.isDefined(t.gt.field)&&r.isDefined(t.gt.val)&&(n+=-1===n.indexOf("?")?"?":"&",n+="filter[where]["+t.gt.field+"][gt]="+t.gt.val);var f=e.localStorage.itms_user_access_token;return-1===n.indexOf("?")&&(n+="?"),n+="&access_token="+f,console.log(n),n}function n(e){var r=new RegExp("[^/]+"),t=e.match(r)[0];return e.replace(t,i(t))}function i(e){return inflection.pluralize(e)}function o(e,t){var n=e.all(t);return n.success=function(e){return n.then(function(t){var n=[];r.forEach(t,function(e){""===e.data?n.push(e.status):n.push(e.data)}),e(n)}),n},n.error=function(e){return n.then(null,function(t){var n=[];r.forEach(t,function(e){n.push(e.status)}),e(n)}),n},n}function f(e){return e.then(function(e){s(e)},function(e){u(e)}),e}function s(e){return e}function u(e){var r;switch(e.status){case 404:r="请求的远端服务不存在!";break;case 500:r="请求的远程服务出错！"}console.log("[http request error]: "+r)}function c(){}function a(e,i,s){function u(i,o){if(r.isString(i)&&""!==i){var u=s.serverUrl+n(i);return r.isObject(o)&&!r.isArray(o)&&(o.hasOwnProperty("count")&&(u+="/count"),u+=t(o)),f(e.get(u))}}function c(t,i){if(r.isString(t)&&""!==t&&r.isArray(i)){var o=s.serverUrl+n(t);return f(e.post(o,i))}}function a(t,f){if(r.isString(t)&&""!==t&&r.isArray(f)){var u=s.serverUrl+n(t),c=[];return r.forEach(f,function(r){c.push(e.put(u,r))}),o(i,c)}}function l(t,f){function c(t){var n=[];return r.forEach(t,function(t){var i;r.isString(t)?i=e.delete(a+"/"+t):r.isObject(t)&&(i=e.delete(a+"/"+t.id)),n.push(i)}),n}if(r.isString(t)&&""!==t){var a=s.serverUrl+n(t);if(r.isArray(f))return o(i,c(f));if(r.isObject(f)){var l,h,d=u(t,f);return d.success=function(e){return l=e,d},d.error=function(e){return h=e,d},d.then(function(e){var t=e.data;d=i.all(c(t)),d.then(function(e){var t=[];r.forEach(e,function(e){t.push(e.status)}),l(t)},function(e){var t=[];r.forEach(e,function(e){t.push(e.status)}),h(t)})}),d}}}function h(i,o,u,c,a){if(r.isString(i)&&""!==i){var l=s.serverUrl+n(i);r.isObject(c)&&!r.isArray(c)&&(l+=t(c));var h;if(u)switch(l=l+"/"+a,o.toLowerCase()){case"get":h=e.get(l);break;case"put":h=e.put(l);break;case"post":h=e.post(l);break;case"del":h=e.delete(l);break;case"delete":h=e.delete(l)}else switch(o.toLowerCase()){case"get":h=e.get(l);break;case"put":h=e.put(l,a);break;case"post":h=e.post(l,a);break;case"del":h=e.delete(l,a);break;case"delete":h=e.delete(l,a)}return f(h)}}function d(){}return s.hasOwnProperty("serverUrl")?(d.find=function(e,r){return u(e,r)},d.create=function(e,r){return c(e,r)},d.update=function(e,r,t){return a(e,r,t)},d.destroy=function(e,r){return l(e,r)},d.customInterface=function(e,r,t,n,i){return h(e,r,t,n,i)},d):"Phoebe load failure!"}function l(e){return d.hasOwnProperty(e)}function h(e){function t(e,t){var n=[];return r.forEach(e,function(e){r.forEach(t,function(r){e.hasOwnProperty(r)&&delete e[r]}),n.push(e)}),n}function n(e,r){return l(e)?d[e]:(this.url=e,this.include=null,this.wherestr=null,this.pkfield=r?r:"id",d[this.url]=this,void 0)}return n.prototype.query=function(t){return r.isObject(t)&&(this.include=t.include,this.wherestr=t),e.find(this.url,t)},n.prototype.save=function(n){return n=r.copy(n),this.include&&(n=t(n,this.include)),e.update(this.url,n,this.pkfield)},n.prototype.delete=function(t){return t=r.copy(t),e.destroy(this.url,t)},n.prototype.setInterface=function(t){var n=this;return r.forEach(t,function(r,t){n[t]=function(n,i){var o=this.url+"/"+t,f=r.hasOwnProperty("method")?r.method:"get",s=r.hasOwnProperty("path")?r.path:!1;return e.customInterface(o,f,s,n,i)}}),d[this.url]=this,this},n}r.module("phoebe.httpService",[]).config(c).factory("PhoebeHttpService",a),c.$inject=["$httpProvider"],a.$inject=["$http","$q","$phoebe"],r.module("phoebe.resource",[]).factory("PhoebeResource",h);var d={};h.$inject=["PhoebeHttpService"]}(window,window.angular);
